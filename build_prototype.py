...
views = {
    ...
    <div x-data="{ tab: 'dados' }">
        ...
        <div class="flex space-x-1 bg-white p-1 rounded-t-xl border border-gray-200 border-b-0 overflow-x-auto">
            <button @click="tab = 'dados'" :class="tab === 'dados' ? 'bg-indigo-50 text-indigo-700 border-indigo-200' : 'text-gray-500 hover:bg-gray-50'" class="px-4 py-2.5 text-sm font-medium rounded-lg border border-transparent transition-colors whitespace-nowrap">
                <i class="fas fa-info-circle mr-2"></i>Dados Básicos
            </button>
            <button @click="tab = 'descricao'" :class="tab === 'descricao' ? 'bg-indigo-50 text-indigo-700 border-indigo-200' : 'text-gray-500 hover:bg-gray-50'" class="px-4 py-2.5 text-sm font-medium rounded-lg border border-transparent transition-colors whitespace-nowrap">
                <i class="fas fa-align-left mr-2"></i>Desc. Comercial
            </button>
            <button @click="tab = 'multimidia'" :class="tab === 'multimidia' ? 'bg-indigo-50 text-indigo-700 border-indigo-200' : 'text-gray-500 hover:bg-gray-50'" class="px-4 py-2.5 text-sm font-medium rounded-lg border border-transparent transition-colors whitespace-nowrap">
                <i class="fas fa-image mr-2"></i>Multimídia
            </button>
            <button @click="tab = 'ofertas'" :class="tab === 'ofertas' ? 'bg-indigo-50 text-indigo-700 border-indigo-200' : 'text-gray-500 hover:bg-gray-50'" class="px-4 py-2.5 text-sm font-medium rounded-lg border border-transparent transition-colors whitespace-nowrap">
                <i class="fas fa-tags mr-2"></i>Ofertas
            </button>
            <button @click="tab = 'documentacao'" :class="tab === 'documentacao' ? 'bg-indigo-50 text-indigo-700 border-indigo-200' : 'text-gray-500 hover:bg-gray-50'" class="px-4 py-2.5 text-sm font-medium rounded-lg border border-transparent transition-colors whitespace-nowrap">
