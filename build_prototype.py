...
views = {
            ...
            <div class="p-8">
                <form @submit.prevent="currentView = 'home'">
                    ...
                    <div class="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2 text-center">Validação de Segurança</label>
                        <div class="text-center font-mono text-2xl font-bold tracking-[0.3em] text-indigo-800 bg-white py-2 rounded border border-gray-200 mb-3 select-none">
                            X7<span class="text-gray-400">A</span>9<span class="text-indigo-400">Q</span>
                        </div>
                        <input type="text" class="w-full text-center px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder="Digite o código">
                    </div>
    ...
    <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-100 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Código PNO</label>
                <input type="text" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500 outline-none" placeholder="Ex: 63652">
            </div>
            <div>
                <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Nome do Serviço</label>
                <input type="text" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500 outline-none" placeholder="Buscar...">
            </div>
            <div>
                <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Fornecedor</label>
                <select class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500 outline-none">
                    <option>Todos os fornecedores</option>
                    <option>Terra Networks</option>
                    <option>Digital Virgo</option>
                </select>
            </div>
            <div class="flex items-end">
                <button class="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-2 px-4 rounded-lg transition-colors flex justify-center items-center gap-2">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
            <span class="text-sm text-gray-500 font-medium">Mostrando 5 de 50 registros</span>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-white">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Cód. Integração</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-indigo-600">63652</td>
                        <td class="px-6 py-4 text-sm text-gray-900 font-medium">Vale Saúde Farma</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Terra Networks</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400 font-mono">20260915142131</td>
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-700">Inativo</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <button @click="currentView = 'edicao-pno'" class="text-gray-400 hover:text-indigo-600 transition-colors p-2" title="Editar / Gerenciar"><i class="fas fa-cog"></i></button>
                        </td>
                    </tr>
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400 font-mono">20260910210857</td>
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-700">Ativo</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <button @click="currentView = 'edicao-pno'" class="text-gray-400 hover:text-indigo-600 transition-colors p-2" title="Editar / Gerenciar"><i class="fas fa-cog"></i></button>
                        </td>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-8 py-6 border-b border-gray-100 bg-gray-50">
            <h3 class="text-lg font-semibold text-gray-700">Informações Iniciais</h3>
            <p class="text-sm text-gray-500">Crie o serviço para habilitar as abas de Multimídia, Ofertas e Documentação.</p>
        </div>
        ...
        <div class="p-8">
            <form class="space-y-6" @submit.prevent="currentView = 'edicao-pno'">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Código PNO</label>
                        <input type="text" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 bg-gray-100 text-gray-500 cursor-not-allowed" value="Gerado após salvar" disabled>
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Nome do Serviço <span class="text-red-500">*</span></label>
                        <input type="text" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500 outline-none" placeholder="Ex: Globoplay Premium" required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500 outline-none" required>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Classificação</label>
                ...
                <div class="pt-6 flex justify-end gap-4 border-t border-gray-100">
                    <button type="button" @click="currentView = 'home'" class="px-6 py-2.5 border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-colors">
                        Cancelar
                    </button>
                    <button type="submit" class="px-6 py-2.5 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 shadow-md shadow-indigo-200 transition-colors flex items-center gap-2">
    ...
    <div x-data="{ tab: 'dados' }">
        ...
        <!-- PNO Tabs Navigation -->
        <div class="flex space-x-1 bg-white p-1 rounded-t-xl border border-gray-200 border-b-0">
            <button @click="tab = 'dados'" :class="tab === 'dados' ? 'bg-indigo-50 text-indigo-700 border-indigo-200' : 'text-gray-500 hover:bg-gray-50'" class="px-4 py-2.5 text-sm font-medium rounded-lg border border-transparent transition-colors">
                <i class="fas fa-info-circle mr-2"></i>Dados Básicos
            </button>
            <button @click="tab = 'descricao'" :class="tab === 'descricao' ? 'bg-indigo-50 text-indigo-700 border-indigo-200' : 'text-gray-500 hover:bg-gray-50'" class="px-4 py-2.5 text-sm font-medium rounded-lg border border-transparent transition-colors">
                <i class="fas fa-align-left mr-2"></i>Desc. Comercial
            </button>
            <button @click="tab = 'multimidia'" :class="tab === 'multimidia' ? 'bg-indigo-50 text-indigo-700 border-indigo-200' : 'text-gray-500 hover:bg-gray-50'" class="px-4 py-2.5 text-sm font-medium rounded-lg border border-transparent transition-colors">
                <i class="fas fa-image mr-2"></i>Multimídia
            </button>
            <button @click="tab = 'ofertas'" :class="tab === 'ofertas' ? 'bg-indigo-50 text-indigo-700 border-indigo-200' : 'text-gray-500 hover:bg-gray-50'" class="px-4 py-2.5 text-sm font-medium rounded-lg border border-transparent transition-colors">
                <i class="fas fa-tags mr-2"></i>Ofertas
            </button>
            <button @click="tab = 'documentacao'" :class="tab === 'documentacao' ? 'bg-indigo-50 text-indigo-700 border-indigo-200' : 'text-gray-500 hover:bg-gray-50'" class="px-4 py-2.5 text-sm font-medium rounded-lg border border-transparent transition-colors">
                <i class="fas fa-file-pdf mr-2"></i>Documentação
            </button>
        </div>
        ...
        <div class="bg-white rounded-b-xl rounded-tr-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div x-show="tab === 'dados'" class="p-8">
                <form class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Código PNO</label>
                            <input type="text" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 bg-gray-100 text-gray-500 cursor-not-allowed" value="63650" disabled>
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Nome do Serviço</label>
                            <input type="text" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500 outline-none" value="Teatrix Premium">
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500 outline-none">
                                <option>Terra Networks</option>
                                <option selected>Digital Virgo</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Classificação</label>
                            <select class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500 outline-none">
                                <option>Entretenimento</option>
                                <option selected>Streaming & Teatro</option>
                            </select>
                        </div>
                    </div>
                    <div class="pt-4 pb-2 border-t border-gray-100">
                        <label class="block text-sm font-semibold text-gray-700 mb-4">Plataformas Suportadas</label>
                        <div class="flex flex-wrap gap-6">
                            <label class="flex items-center gap-2 cursor-pointer p-3 border border-indigo-200 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors">
                                <input type="checkbox" class="w-5 h-5 text-indigo-600 rounded" checked>
                                <span class="text-indigo-900 font-medium"><i class="fas fa-desktop text-indigo-500 mr-1"></i> Web / Desktop</span>
                            </label>
                            <label class="flex items-center gap-2 cursor-pointer p-3 border border-indigo-200 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors">
                                <input type="checkbox" class="w-5 h-5 text-indigo-600 rounded" checked>
                                <span class="text-indigo-900 font-medium"><i class="fab fa-android text-green-600 mr-1"></i> Android</span>
                            </label>
                            <label class="flex items-center gap-2 cursor-pointer p-3 border border-indigo-200 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors">
                                <input type="checkbox" class="w-5 h-5 text-indigo-600 rounded" checked>
                                <span class="text-indigo-900 font-medium"><i class="fab fa-apple text-gray-800 mr-1"></i> iOS</span>
                            </label>
                        </div>
                    </div>
                    <div class="pt-6 flex justify-end gap-4 border-t border-gray-100">
                        <button type="button" class="px-6 py-2.5 border border-red-300 text-red-600 font-medium rounded-lg hover:bg-red-50 transition-colors mr-auto">
                            Inativar Serviço
                        </button>
                        <button type="button" class="px-6 py-2.5 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 shadow-md shadow-indigo-200 transition-colors flex items-center gap-2">
                            <i class="fas fa-check"></i> Salvar Dados Iniciais
                        </button>
                    </div>
                </form>
            </div>

            <!-- Descrição Comercial Tab -->
            <div x-show="tab === 'descricao'" style="display: none;" class="p-8">
                ...
                <form class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Idioma (Lenguaje)</label>
                            <select class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500 outline-none">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Nome Comercial</label>
                            <input type="text" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500 outline-none" value="Teatrix Premium BR">
                        </div>
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Descrição Curta</label>
                        <input type="text" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-indigo-500 outline-none" value="O melhor do teatro em casa.">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Descrição Longa (HTML/Texto)</label>
                        <div class="border border-gray-300 rounded-lg overflow-hidden">
                            <div class="bg-gray-100 px-3 py-2 border-b border-gray-300 flex gap-2">
                                <button type="button" class="p-1 hover:bg-gray-200 rounded text-gray-600"><i class="fas fa-bold"></i></button>
                                <button type="button" class="p-1 hover:bg-gray-200 rounded text-gray-600"><i class="fas fa-italic"></i></button>
                                <button type="button" class="p-1 hover:bg-gray-200 rounded text-gray-600"><i class="fas fa-link"></i></button>
                            </div>
                            <textarea class="w-full p-4 h-32 focus:outline-none" placeholder="Escreva a descrição detalhada do serviço..."></textarea>
                        </div>
                    </div>
                    <div class="pt-6 flex justify-end gap-4 border-t border-gray-100">
                        <button type="button" class="px-6 py-2.5 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 shadow-md shadow-indigo-200 transition-colors flex items-center gap-2">
                            <i class="fas fa-plus"></i> Adicionar Configuração Comercial
                        </button>
                    </div>
                </form>
            </div>

            <!-- Outras Tabs Vias Empty States -->
    ...
    <div class="bg-white p-5 rounded-xl shadow-sm border border-gray-100 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Loja (Tienda)</label>
                <select class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500 outline-none">
                    <option>BR VIVO STORE</option>
                </select>
            </div>
            <div>
                <label class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Operadora</label>
                <select class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-indigo-500 outline-none">
                    <option>VIVO BRASIL</option>
                </select>
            </div>
            <div class="flex items-end">
                <button class="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-2 px-4 rounded-lg transition-colors flex justify-center items-center gap-2">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Nome da Campanha</th>
                    <th class="px-6 py-4 text-center text-xs font-bold text-gray-500 uppercase tracking-wider">+18</th>
                    <th class="px-6 py-4 text-center text-xs font-bold text-gray-500 uppercase tracking-wider">Status</th>
                    <th class="px-6 py-4 text-right text-xs font-bold text-gray-500 uppercase tracking-wider">Ações</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-100">
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="w-16 h-8 bg-red-500 rounded flex items-center justify-center text-white text-xs font-bold shadow-inner">NETFLIX</div>
                    </td>
                    <td class="px-6 py-4 text-sm text-gray-700 font-medium">NETFLIX_01_09_2026</td>
                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium text-gray-500">NÃO</td>
                    <td class="px-6 py-4 whitespace-nowrap text-center">
                        <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-700">Ativo</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <button class="text-gray-400 hover:text-indigo-600 transition-colors p-2"><i class="fas fa-edit"></i></button>
                    </td>
                </tr>
            </tbody>
        </table>
